...
Веб-платформа для сети барбершопов: онлайн-запись, ролевая модель «клиент / барбер / менеджер / администратор», управление расписанием филиалов и аналитика. Курсовая работа по дисциплине «Проектирование информационных систем» (СФУ, ИУБП).
...
Симонов Данил (D12nzo), Курсовая работа 2026 г.
